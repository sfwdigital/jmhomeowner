					...
					<div class="grid-container">
						<div class="grid-x grid-margin-x">
							<div class="cell medium-18">
								<div class="product-description-wrapper">
									<div class="grid-x grid-margin-x align-middle" data-equalizer>
										<div class="cell small-6 medium-6 rvalue-card text-center <?php echo $rvalue; ?>" data-equalizer-watch><!-- bg changes based on rvalue -->
											<?php echo $r_header; ?>
										</div>
										<div class="cell small-18 meidum-18 product-description" data-equalizer-watch>
											<h5>Product Type Title</h5>
											<p><small>Product type description - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lorem enim, tristique.</small></p>
										</div>
									</div>
									<div class="grid-x grid-margin-x align-middle" data-equalizer>
										<div class="cell small-6 medium-6 rvalue-card text-center <?php echo $rvalue; ?>" data-equalizer-watch><!-- bg changes based on rvalue -->
							...
							<div class="cell medium-6">
								<img src="http://placehold.it/348x450" alt="Scale Model of Product" />
							</div>
						</div>
						<div class="grid-x grid-margin-x">
